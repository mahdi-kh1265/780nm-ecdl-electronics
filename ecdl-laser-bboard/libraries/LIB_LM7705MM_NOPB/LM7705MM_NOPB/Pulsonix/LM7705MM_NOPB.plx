...
//561162/1910885/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM7705MM_NOPB" (originalName "LM7705MM_NOPB")
	...
	(compDef "LM7705MM_NOPB" (originalName "LM7705MM_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "CF+") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "VSS_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "SD") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "VDD") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "CF-") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "CRES") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VOUT") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VSS_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM7705MM_NOPB"))
		...
		(attr "Mouser Part Number" "926-LM7705MM/NOPB")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LM7705MM-NOPB?qs=QbsRYf82W3EUoG7CCLtS5A%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "LM7705MM/NOPB")
		(attr "Description" "Low Noise Negative Bias Generator")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/LM7705")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "LM7705MM_NOPB.stp")
