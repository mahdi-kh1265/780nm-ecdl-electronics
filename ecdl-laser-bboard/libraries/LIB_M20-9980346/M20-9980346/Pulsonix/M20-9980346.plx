...
(library Library_1
	...
	(patternDef "HDRV6W64P254_2X3_762X508X864P" (originalName "HDRV6W64P254_2X3_762X508X864P")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.27 -1.27) (pt -1.27 3.81) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.27 3.81) (pt 6.35 3.81) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6.35 3.81) (pt 6.35 -1.27) (width 0.025))
		)
		(layerContents (layerNumRef 28)
	...
	(compDef "M20-9980346" (originalName "M20-9980346") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://content.harwin.com/m/a754d23f2d366891/original/DRG-00478-Technical-Drawing-Datasheet-M20-998-pdf.pdf")
		(attr "<Component Height>" "8.64")
		(attr "<STEP Filename>" "M20-9980346.stp")
