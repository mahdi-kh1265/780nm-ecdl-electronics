...
//380375/1910885/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "OPA192IDR" (originalName "OPA192IDR")
	...
	(compDef "OPA192IDR" (originalName "OPA192IDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "OPA192IDR"))
		...
		(attr "Mouser Part Number" "595-OPA192IDR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/OPA192IDR?qs=wrT8kFYR77%252BLV20WgpFlnQ%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "OPA192IDR")
		(attr "Description" "High-Voltage, Rail-to-Rail Input/Output, 5V, 0.2V/C, Precision Operational Amplifier")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/opa192")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "OPA192IDR.stp")
